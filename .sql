...
===============================================================================================
*/
SELECT  mfinding.new_price, mfinding.content_rating, mfinding.primary_genre,
		AVG(avg_ebt) OVER(PARTITION BY mfinding.primary_genre) AS avg_overall
FROM
...
INNER JOIN cte2
ON a.name = cte2.name
ORDER BY avg_ebt DESC) as mfinding
GROUP BY mfinding.content_rating, mfinding.new_price, mfinding.primary_genre, mfinding.avg_ebt
